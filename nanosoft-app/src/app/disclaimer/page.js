        ...
        <div className="px-[5%] xl:px-[25%]">
          ...
          <div className="text-lg">
            <li className="text-left text-[#555555]  p1 pt-[30px] font-medium ">
              All subscription fees paid to Brain Auto Tech is not
              refundable. We do not provide trading tips nor are we investment
              adviser.
            </li>
            ...
            <div className="text-left text-[#555555]  p1 pt-[30px] font-medium ">
              ...
              <li className="pt-[5px] ">
                ...
                advise by Brain Auto Tech Trades and actual returns may
                ...
                portfolio construction characteristics etc.
              </li>
              <li className="pt-[5px]">
                {" "}
