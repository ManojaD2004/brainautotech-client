    ...
    >
        ...
        <div className="flex flex-row justify-between items-center flex-wrap">
          <div className="md:w-[40%] w-full">
            ...
            <h1 className="text-white text-2xl font-bold h1">
              Brain Auto Tech provides best IT Solution for your business
            </h1>
          </div>
          <div className="md:w-[40%] w-full text-[#9b9aad] text-base p2">
            {`Brain Auto Tech as the name indicates we are an Brain Auto Tech organisation based in Indore (India). 
            We have team of experienced IT and Digital Marketing Professionals who are trying to put our best in making our client’s 
            business more easy and hassle free.`}
          </div>
        </div>
      ...
      <section className="bg-[#eceff3] w-full lg:h-52 h-[800px] flex items-center justify-center">
        <p className="text-[#627792] text-center lg:mt-20 mt-[660px] p3">
          ...
          <span className="text-black underline">Explore our company</span>
        </p>
      </section>
    </section>
  );
